      ...
      <div className="container mx-auto flex justify-between items-center">
        ...
        <div>
          <ul className="flex space-x-4">
            <li>
              <a href="#home" className="text-zinc-700 hover:text-pink-600 font-semibold">
                Home
              </a>
            </li>
            <li>
              <a href="#about" className="text-zinc-700 hover:text-pink-600 font-semibold">
                About
              </a>
            </li>
            <li>
              <a href="#foods" className="text-zinc-700 hover:text-pink-600 font-semibold">
                Foods
              </a>
            </li>
            <li>
              <a href="#contact" className="text-zinc-700 hover:text-pink-600 font-semibold">
                Contact
              </a>
            </li>
          </ul>
